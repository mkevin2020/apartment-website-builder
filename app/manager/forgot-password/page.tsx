...
export default function ManagerForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // The browser can no longer read managers (correctly — those rows are
          ...
          <CardContent className="pt-6 text-center">
            <div className="mb-4">
              ...
              <p className="text-gray-600">
                ...
                review your request and update your password shortly.
              </p>
            </div>
        ...
        <CardContent className="pt-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-center pt-2">
              <Link href="/login" className="text-orange-600 hover:underline flex items-center justify-center gap-1 text-sm">
